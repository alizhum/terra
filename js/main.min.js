...
const eventsViewButtons = document.querySelectorAll('.events__view-button');
const navToggle = document.getElementById('nav-toggle');
const headerMobile = document.getElementById('header-mobile');
const submenuToggle = document.querySelectorAll('.header__nav-item-toggle');
const eventsFilterToggle = document.querySelector('.events__filter-toggle');
const eventsFilterClose = document.querySelector('.events__filter-form-close');
...
eventsFilterToggle?.addEventListener('click', function() {
    document.querySelector('.events__filter-form').classList.toggle('events__filter-form--active');
    document.body.classList.toggle('overflow-hidden');
});

eventsFilterClose?.addEventListener('click', function() {
  document.querySelector('.events__filter-form').classList.toggle('events__filter-form--active');
  document.body.classList.toggle('overflow-hidden');
});
...
submenuToggle.forEach((button) => {
  ...
  button.addEventListener('click', function() {
    ...
    if (window.innerWidth <= 992) {
      ...
      navItem.querySelector('.nav__submenu').slideToggle();
...
if (eventsViewButtons) {
  eventsViewButtons.forEach((button) => {
    button.addEventListener('click', function() {
      if (this.classList.contains('events__view-button--active')) return;

      const parent = this.closest('.events__view');
      parent.querySelector('.events__view-button--active').classList.remove('events__view-button--active');
      this.classList.add('events__view-button--active');

      let sliderDirection = this.dataset.type;
